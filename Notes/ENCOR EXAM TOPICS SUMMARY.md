...
| 2.1          | Describe device virtualization technologies                                                                  | Virtual switching                                                                                                                                                                               |          |     |           |       |
...
| 3.3          | Wireless                                                                                                     | Troubleshoot WLAN configuration and wireless client connectivity issues using GUI only                                                                                                          |          |     |           |       |
...
- # Benefits: High performance, low latency, scalable. Ideal for data centers.
    

#### Cloud-Based Architecture

- # Components: Virtual networks, cloud firewalls, VPCs.
    
- # Providers: AWS, Azure, Google Cloud.
    
- # Benefits: Flexibility, scalability, cost-efficiency. Quick resource scaling.
...
- # Device Redundancy: Backup routers, switches, servers.
    
- # Link Redundancy: Multiple network links.
    
- # Power Redundancy: Backup power supplies, UPS systems.
    
- # Benefit: Minimizes downtime, prevents single points of failure.
    

#### First Hop Redundancy Protocols (FHRP)

- # Objective: Ensures continuous IP gateway availability.
    
- # Types:
    

- # HSRP (Hot Standby Router Protocol): Provides router redundancy.
    
- # VRRP (Virtual Router Redundancy Protocol): Similar to HSRP, open standard.
    
- # GLBP (Gateway Load Balancing Protocol): Balances load and provides redundancy.
    

#### Stateful Switchover (SSO)

- # Objective: Ensures seamless failover between redundant devices.
    
- # Function: Synchronizes state information between primary and backup devices.
...
- # netconf-yang logging
    
- # end
    

4. # Verify NETCONF Capabilities:
    

- # show netconf-yang capabilities
    

### RESTCONF Configuration and Verification Commands
...
2. # Verify RESTCONF Configuration:
    

- # show restconf
    

3. # Configure Authentication for RESTCONF:
...
4. # Configure and Verify RESTCONF Access:
    

- # Configure Access List for RESTCONF:
    

- # configure terminal
    
- # ip access-list standard RESTCONF
