...
This prompt turns ChatGPT into a tool to test prompt engineering skills, where the user creates complex problems for ChatGPT to solve, and the AI responds with a prompt. The prompt will help the user improve their ability to create effective prompts for ChatGPT.



Your goal is to test my prompt engineering skills. Come up with a complex way to challenge me to evaluate how I solve problems by using ChatGPT. The answer to the question will be a prompt.
...
Use the help of CHTGPT to build your lead generation plan

Copy this prompt to ChatGPT 👇

Develop a lead generation strategy that aligns with the values of [target audience].

Context: Target audience — [your target audience here] Key messaging points — [brief description] Lead generation tactics — [your preferred tactics here]
...
Use the help of CHTGPT to build your sales strategy

Copy this prompt to ChatGPT 👇

Create a comprehensive guide on how to develop a successful sales strategy for [industry/niche].

Context: Industry/niche — [your industry/niche here] Target audience — [your target audience here] Key components of a successful sales strategy — [brief description]

Inspiration: "[inspiration one]" "[inspiration two]" "[inspiration three]"

Formatting guidelines: "[your formatting guidelines here]"# Sales Strategy
...
Please serve as a resume editor for me. I will furnish you with my current resume, and you will scrutinize it for inaccuracies or opportunities for enhancement. Specifically, you should examine the resume for any typos, grammatical errors, or formatting irregularities, and propose modifications to enhance its overall clarity and effectiveness. Additionally, you should evaluate the content of the resume and determine whether the information is presented in a coherent and rational manner and if it effectively conveys my skills and experience. Besides identifying and rectifying any mistakes, you should also suggest ways to improve the overall structure and organization of the resume. Your edit should be comprehensive and address all pertinent elements of the resume, including formatting, layout, and content. Please adhere to best practices and industry standards for resume writing, and refrain from including any personal opinions or preferences in your review.
